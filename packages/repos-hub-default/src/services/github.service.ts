import type { GitHubUser, GitHubRepository, SearchUsersResponse } from "../types/github";
...
class GitHubService {
  ...
  async searchUsers(query: string, page = 1, perPage = 10): Promise<SearchUsersResponse> {
