import { GitHubUser, useUserRepositories, Carousel, RepoCard } from "@repos-hub/shared-ui";
...
} from "../components/user-section-card.component";
import { useGithubStore } from "../stores/github-users.store";

export const UserRepositories = () => {
  const { selectedUsers } = useGithubStore();

  return (
    <div className="space-y-4" data-testid="selected-user-repositories">
